...
泄露列（Churn Score，其与 Churn Value 的相关系数高达 0.66）、
...
统计学习方法之一 \cite{hosmer2013applied}。它的输出值严格
...
\subsubsection*{Top 5 关键流失因素}

综合 SHAP 分析结果，各特征的平均 SHAP 绝对值由大到小排序，
前五位关键流失因素及其业务解读如表 \ref{tab:top5} 所示。

\begin{table}[H]
    \centering
    \caption{Top 5 关键流失因素}
    \label{tab:top5}
    \small
    \begin{tabular}{clp{7cm}}
        ...
        相关系数 $-0.35$ 及"0-10 个月高度集中"的直方图分布
...
（$-0.35$）、分组直方图和 SHAP 重要性三种不同方法共同确认；
